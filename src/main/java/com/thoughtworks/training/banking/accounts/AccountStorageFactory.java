...
public class AccountStorageFactory {
  ...
  private Map<String, Account> memoryData() {
    ...
    heaton1.update(new Balance(heaton1.getId(), "cny", new BigDecimal(100000)));
    heaton1.update(new Balance(heaton1.getId(), "usd", new BigDecimal(30000)));
    Account heaton2 = new Account(2L, "2001", "Heaton", "heaton");
    heaton2.update(new Balance(heaton2.getId(), "cny", new BigDecimal(200000)));
    Account qinyu = new Account(3L, "1002", "Qinyu", "qinyu");
    qinyu.update(new Balance(qinyu.getId(), "cny", new BigDecimal(80000)));
    qinyu.update(new Balance(qinyu.getId(), "usd", new BigDecimal(0)));
